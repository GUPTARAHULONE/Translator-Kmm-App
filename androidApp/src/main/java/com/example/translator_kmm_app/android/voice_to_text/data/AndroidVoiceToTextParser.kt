package com.example.kmm_translator.android.voice_to_text.data
...
import com.example.kmm_translator.core.domain.utils.toCommonStateFlow
import com.example.kmm_translator.voice_to_text.domain.VoiceToTextParser
import com.example.kmm_translator.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    override fun onRmsChanged(rmsDb: Float) {
        // for normalize the power ratio  to 0 to 1
        _state.update {
            it.copy(
