...
// Extension function to get the colors
// Color is struct here, so cant use Convenience params
extension Color{
    // for converting the shared long  values to actual color here for IOS
...
// for dark and light theme making Uicolor from Uikit
// UIColor is class here,convenience is used for secondary constructor
